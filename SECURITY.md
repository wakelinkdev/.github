...
Instead, please report them via email to **security@wakelinkdev.org**.
...
We believe in recognizing security researchers who help keep WakeLink secure:

- Acknowledgment in our security advisories (if desired)
- Listing in our Hall of Fame (coming soon)
- Potential monetary rewards for critical vulnerabilities (case by case)
...
- **Security issues:** security@wakelink.io
- **PGP Key:** [Coming soon]

---

Thank you for helping keep WakeLink and our users safe! 🛡️
